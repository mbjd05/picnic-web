...
| **III. Forbidden Anti-Patterns** | PASS | The added cart-credit extraction remains within the cart parser responsibility boundary. No magic strings (label comes from API or named constant). No deep nesting. |
