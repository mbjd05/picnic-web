...
const translations = {
  ...
  FR: {
    ...
    minimumCheckoutMessage:
      "Vous pouvez passer à la caisse à partir de {minimum}. Votre panier est actuellement de {current}.",
...
const englishTranslations: Translations = {
  ...
  minimumCheckoutMessage: "You can check out from {minimum}. Your cart is now {current}.",
